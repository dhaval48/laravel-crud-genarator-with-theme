            ...
            <tbody v-if="lists.lists.data.length > 0">
                <tr v-for="list in lists.lists.data">
                    ...
                    <td>
                        ...
                        <div class="btn-group">
                            <button type="button" class="btn btn-default btn-sm dropdown-toggle pull-right custom-default" data-toggle="dropdown" tabindex="-1" aria-haspopup="true" aria-expanded="false">
                                Action
                            </button>
